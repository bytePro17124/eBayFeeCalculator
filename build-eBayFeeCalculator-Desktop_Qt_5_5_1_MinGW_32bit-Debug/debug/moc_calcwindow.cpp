/****************************************************************************
** Meta object code from reading C++ file 'calcwindow.h'
**
...
#error "The header file 'calcwindow.h' doesn't include <QObject>."
...
const QMetaObject CalcWindow::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_CalcWindow.data,
      qt_meta_data_CalcWindow,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CalcWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CalcWindow.stringdata0))
        return static_cast<void*>(const_cast< CalcWindow*>(this));
